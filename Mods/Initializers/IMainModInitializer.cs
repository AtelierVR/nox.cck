...
namespace Nox.CCK.Mods.Initializers {
	...
	public interface IMainModInitializer : IModInitializer {
		...
		public UniTask OnInitializeMainAsync(IMainModCoreAPI api)
		...
		/// </summary>
		/// <returns>A task representing the asynchronous operation.</returns>
		public UniTask OnPostInitializeMainAsync()
			=> UniTask.CompletedTask;
		...
		/// </summary>
		/// <returns>A task representing the asynchronous operation.</returns>
		public UniTask OnPreDisposeMainAsync()
			=> UniTask.CompletedTask;
		...
		/// </summary>
		/// <returns>A task representing the asynchronous operation.</returns>
		public UniTask OnDisposeMainAsync()
			=> UniTask.CompletedTask;

		#if UNITY_EDITOR
		/// <summary>
		/// Called when entering play mode in the Unity Editor.
		/// </summary>
		public void OnEnterPlayMode() { }

		/// <summary>
		/// Called when exiting play mode in the Unity Editor.
		/// </summary>
